...
import com.kirchhoff.movies.screen.tvshow.ui.screen.details.NewTvShowDetailsFragment
...
class TvShowFacade : ITvShowFacade {
    ...
    override fun tvShowDetails(tv: UITv): Fragment = NewTvShowDetailsFragment.newInstance(tv)
